...
console.log(
  chalk.hex('#d7a1ff').italic('     B A I L E Y S ━ C L S S Y\n') +
  chalk.hex('#a78bfa').italic('           T H A N K S - Y O U - A L L\n\n') +
  chalk.hex('#89CFF0').italic('     last updated • 1 Maret 2026\n') +
  chalk.hex('#c084fc').italic('     MODIF BAIL - BY @VinzzXvStec\n') +
  chalk.hex('#a78bfa').italic('           Telegram Owner: @VinzzXvStec\n\n') +
